            ...
            <div class="col-8 offset-2 bg-white">
                ...
                <form method="POST" action="{{ route('sell.updateSellInformation')}}" class="p-5" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                        ...
                        <img id="icon_img_prv" class="img-thumbnail h-50 w-50 mb-3" {{$item->image_file}} ? src="/storage/item-images/{{$item->image_file}}" : src="{{ asset('images/item-image-default.png')}}" alt="">
                    </div>
                    {{-- 商品画像 --}}
